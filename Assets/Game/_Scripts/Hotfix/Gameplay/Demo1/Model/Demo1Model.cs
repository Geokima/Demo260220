...
namespace Game.Gameplay.Demo1
{
    public class Demo1Model : AbstractModel
    {
        ...
        public BindableProperty<int> CurrentShield = new BindableProperty<int>(0);
        ...
        #region 场景状态
        public BindableProperty<SceneMode> CurrentSceneMode = new BindableProperty<SceneMode>(SceneMode.Selection);
