...
{
    public class UI_ShopZone : UI_SlotZoneBase
    {
        ...
        public System.Action<CardModel> OnBuy;
        ...
        public UI_CardView AddShopCard(CardModel model, int? startIndex = null)
        {
        ...
        public bool RemoveShopCard(UI_CardView view)
        {
            if (view == null)
                return false;
        ...
        public override bool CanAccept(UIDragPayload payload, PointerEventData eventData) => false;
        public override bool Accept(UIDragPayload payload, PointerEventData eventData) => false;
        ...
        private void OnCardClicked(UI_CardView view)
        {
        ...
        private class ShopItem
        {
            ...
            public ShopItem(UI_CardView view, int widthInCells)
            {
                View = view;
