...
{
    public class Widget_CardView : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
    {
        ...
        public Widget_DropZoneBase OwnerZone { get; internal set; }
        ...
        public Action<Widget_CardView> Clicked;
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            if (!Draggable)
                return;
            Demo1Architecture.Instance.GetSystem<IDragSystem>().BeginDrag(this, eventData);
        }
        ...
        public void OnDrag(PointerEventData eventData)
        {
            if (!Draggable)
                return;
            Demo1Architecture.Instance.GetSystem<IDragSystem>().Drag(eventData);
        }
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            if (!Draggable)
                return;
            Demo1Architecture.Instance.GetSystem<IDragSystem>().EndDrag(eventData);
        }
